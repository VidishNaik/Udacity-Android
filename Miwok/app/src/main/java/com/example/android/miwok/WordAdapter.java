...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public WordAdapter(Context context, ArrayList<Word> words, int colors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int colorsa = ContextCompat.getColor(getContext(), mcolors);
        textContainer.setBackgroundColor(colorsa);
